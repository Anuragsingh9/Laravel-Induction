...
<form class="form-horizontal" action="/update/{{$Edit['id']}}" method="POST">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="password" class="form-control" id="pass" placeholder="Enter Password" name="password" value="{{$Edit['password']}}">
        </div>
      </div>
     ...
     <div class="pad"> 
      ...
      <div class="form-group">
        ...
        <input type="textarea" class="form-control" rows="5" column="4" id="comment" name="comments" value="{{$Edit['comments']}}">
      </div>
